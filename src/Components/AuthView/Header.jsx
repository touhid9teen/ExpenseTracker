...
const Header = ({ mode }) => (
  <div className="text-center">
    <div className="inline-flex items-center justify-center w-11 h-11 cyber-cut bg-gradient-to-br from-amber-500 to-cyan-500 shadow-[4px_4px_0px_rgba(34,211,238,0.35)] mb-3">
    ...
    <h2 className="text-2xl font-extrabold text-slate-900 tracking-tight flex items-center justify-center gap-2">
      ...
      <span className="inline-block w-1.5 h-6 cyber-cut-sm bg-gradient-to-b from-amber-500 to-cyan-500" />
    </h2>
