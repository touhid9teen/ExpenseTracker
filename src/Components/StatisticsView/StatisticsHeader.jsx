        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between">
            ...
            <div className="mt-2 md:mt-0 flex items-center gap-2">
                ...
                <button
                    ...
                    className="hidden sm:inline-block px-4 py-1.5 cyber-cut-sm text-xs font-bold text-white bg-gradient-to-r from-amber-500 to-cyan-500 hover:from-amber-400 hover:to-cyan-400 shadow-[3px_3px_0px_rgba(34,211,238,0.3)]"
                >
                    Open Ledger →
                </button>
            </div>
