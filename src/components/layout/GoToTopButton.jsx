...
const GoToTopButton = memo(function GoToTopButton({ darkMode }) {
  ...
  return (
    <button
      ...
      className={`fixed bottom-24 lg:bottom-6 right-4 sm:right-6 z-40 w-11 h-11 cyber-cut flex items-center justify-center border-2 transition-all duration-200 hover:-translate-y-1 active:scale-95 cyber-3d-sm ${
        darkMode
