            ...
            {CATEGORIES.map((cat) => {
                ...
                return (
                    <button
                        ...
                        className={`group flex flex-col items-center justify-center gap-1.5 py-3 px-2 rounded-2xl border-2 transition-all duration-200 hover:-translate-y-0.5 active:scale-95 focus:outline-none ${
                            isActive
                    ...
                    >
                        <span className={`w-9 h-9 rounded-lg flex items-center justify-center ${styles.bg}`}>
