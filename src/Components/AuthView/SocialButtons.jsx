    ...
    <div className="grid grid-cols-3 gap-2.5">
      {providers.map(({ name, Glyph }) => (
        <button
          ...
          className="flex items-center justify-center gap-1.5 py-2.5 px-2 cyber-cut-sm border-2 border-slate-200 bg-white text-slate-700 text-xs font-semibold hover:bg-slate-50 hover:border-violet-400 hover:shadow-[3px_3px_0px_rgba(139,92,246,0.3)] transition-all duration-200 disabled:opacity-50"
        >
