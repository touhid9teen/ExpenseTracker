...
const ExpenseClipperScreen = (props) => {
    ...
    return (
        <div className={`min-h-screen font-sans transition-colors duration-300 pb-20 sm:pb-0 ${props.darkMode ? "bg-[#0b0f19] text-slate-100" : "bg-[#f8fafc] text-slate-800"}`}>
            ...
            <div className={`sm:hidden fixed bottom-0 left-0 right-0 z-40 px-6 py-2 flex justify-around items-center border-t backdrop-blur-lg shadow-lg ${props.darkMode ? "bg-slate-950/90 border-slate-800/80 text-slate-400" : "bg-white/85 border-slate-200/80 text-slate-500"}`}>
                <button 
