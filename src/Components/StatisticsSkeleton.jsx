  ...
  return (
    <div className="space-y-8 animate-fadeIn" aria-label="Loading statistics">
      ...
      <div className={`p-6 rounded-2xl border ${darkMode ? "border-slate-800/80" : "border-slate-200"}`}>
        <Skeleton variant="title" darkMode={darkMode} className="mb-4 !h-5 !w-48" />
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className={`p-4 rounded-xl border ${darkMode ? "border-slate-800/60" : "border-slate-200"}`}>
              <Skeleton variant="badge" darkMode={darkMode} className="!h-4 !w-28 mb-2" />
              <Skeleton variant="heading" darkMode={darkMode} className="!h-6 !w-20 mb-1" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className={`p-6 rounded-2xl border ${darkMode ? "border-slate-800/80" : "border-slate-200"}`}>
          <Skeleton variant="title" darkMode={darkMode} className="mb-4 !h-5 !w-40" />
