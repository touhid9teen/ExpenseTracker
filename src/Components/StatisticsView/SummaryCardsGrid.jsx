const SummaryCard = ({ darkMode, title, value, icon, accentClass, note }) => (
...
export const SummaryCardsGrid = ({ darkMode, summaryCards, dateLabels }) => {
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <SummaryCard darkMode={darkMode} title="All-Time Total" value={summaryCards.total} note="Filtered active dataset" accentClass="bg-emerald-500/10 text-emerald-500" icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5"><path strokeLinecap="round" strokeLinejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></svg>} />
            <SummaryCard darkMode={darkMode} title="Today&apos;s Expense" value={summaryCards.today} note={dateLabels.today} accentClass="bg-teal-500/10 text-teal-500" icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5"><path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>} />
            <SummaryCard darkMode={darkMode} title="This Week" value={summaryCards.week} note={dateLabels.week} accentClass="bg-cyan-500/10 text-cyan-500" icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5"><path strokeLinecap="round" strokeLinejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 002 2h2a2 2 0 002-2z" /></svg>} />
            <SummaryCard darkMode={darkMode} title="This Month" value={summaryCards.month} note={dateLabels.month} accentClass="bg-purple-500/10 text-purple-500" icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5"><path strokeLinecap="round" strokeLinejoin="round" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z" /><path strokeLinecap="round" strokeLinejoin="round" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z" /></svg>} />
        </div>
    );
};
